...
def codex_brief(task: str, profile: str = "default") -> dict:
    ...
    return {
        ...
        "provenance_entries": pack.get("provenance_entries", []),
        "provenance_verified": pack.get("provenance_verified", False),
        "provenance_verification": pack.get("provenance_verification", {}),
        "risks": pack["risks"],
        "context_pack": pack,
